...
import { Text, Flex, Skeleton, Box, Image } from '@zaigar-finance/uikit'
  ...
  return (
    <Flex flexDirection={['column-reverse', null, 'row']}>
      <Flex flexDirection="column" flex="2">
        {burnedCakeAmount !== 0 ? (
          <Balance fontSize="64px" bold value={burnedCakeAmount} decimals={0} unit=" ZFAI" />
        ) : (
      ...
      <Flex flex="1" alignSelf="center">
        <Box width="350px">
          <Image width={350} height={320} src="/images/burnt-cake.png" alt={t('Burnt ZFAI')} />
        </Box>
      </Flex>
    </Flex>
  )
