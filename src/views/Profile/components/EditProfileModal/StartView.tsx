...
import { Button, Flex, Text, InjectedModalProps } from '@zaigar-finance/uikit'
...
const StartPage: React.FC<StartPageProps> = ({ goToApprove, goToChange, goToRemove, onDismiss }) => {
  ...
  /**
   * Check if the wallet has the required ZFAI allowance to change their profile pic or reactivate
      ...
      <Flex alignItems="center" style={{ height: '48px' }} justifyContent="center">
        <Text as="p" color="failure">
          {!hasMinimumCakeRequired &&
            t('%minimum% ZFAI required to change profile pic', { minimum: getFullDisplayBalance(minimumCakeRequired) })}
        </Text>
      </Flex>
      {profile.isActive ? (
        <>
