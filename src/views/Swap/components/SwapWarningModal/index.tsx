...
import { ModalBody, ModalContainer, Message, ModalHeader, Box, Heading } from '@zaigar-finance/uikit'
...
import ZaifWarning from './ZaifWarning'
...
const SwapWarningModal: React.FC<SwapWarningModalProps> = ({ swapCurrency, onDismiss }) => {
  ...
  const TOKEN_WARNINGS = {
    ...
    [getAddress(SwapWarningTokensConfig.zaif.address)]: {
      symbol: SwapWarningTokensConfig.zaif.symbol,
      component: <ZaifWarning />,
    },
  }
