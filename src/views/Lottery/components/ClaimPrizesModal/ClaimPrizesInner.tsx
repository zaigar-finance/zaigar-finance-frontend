...
import { Flex, Button, Text, AutoRenewIcon, PresentWonIcon } from '@zaigar-finance/uikit'
  ...
  const handleClaim = async () => {
    ...
    try {
      ...
      if (receipt.status) {
        toastSuccess(
          t('Prizes Collected!'),
          t('Your ZFAI prizes for round %lotteryId% have been sent to your wallet', { lotteryId }),
        )
        setPendingTx(false)
