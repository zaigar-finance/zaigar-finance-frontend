...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and ZFAI pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and ZFAI pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from ZFAI pool', data)
  }
