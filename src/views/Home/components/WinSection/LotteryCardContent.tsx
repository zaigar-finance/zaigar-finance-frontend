...
import { Flex, Text, Skeleton, Link, Button, ArrowForwardIcon } from '@zaigar-finance/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in ZFAI prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with ZFAI, win ZFAI if your numbers match')}
        </Text>
      </Flex>
