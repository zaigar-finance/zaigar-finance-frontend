...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@zaigar-finance/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'ZFAI card' },
    { src: 'green', alt: 'Green ZFAI card with up arrow' },
    { src: 'red', alt: 'Red Cake card with down arrow' },
    { src: 'top-right', alt: 'ZFAI card' },
  ],
}
