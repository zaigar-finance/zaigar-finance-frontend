...
import { Card, CardBody, Text, Flex, BlockIcon, LinkExternal } from '@zaigar-finance/uikit'
      ...
      <CardBody p="16px">
        ...
        <RoundResultBox>
          <Flex flexDirection="column" alignItems="center">
            ...
            <LinkExternal href="https://docs.zaigar.finance/products/zai-options" external>
              {t('Learn More')}
            </LinkExternal>
          </Flex>
        </RoundResultBox>
